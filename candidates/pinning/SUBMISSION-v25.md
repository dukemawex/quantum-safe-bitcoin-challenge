# SUBMISSION v25 — fourth draw of the v20 GLV12+lean union package
...
v24 (`d8e37a96`) just resolved: **879,640,393** — it drew the best
self-rate ever recorded on this package (903.9M/s) but a below-median
hit-density seed (1.1601e-7), landing 10.45M under the floor. The
package is at its proven ceiling; the remaining gate is purely the
two-dice draw (worker + seed), so we re-roll the same best bytes.
...
## If this lands below the floor again (v26 would be the same re-roll)
