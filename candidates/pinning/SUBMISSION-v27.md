# SUBMISSION v27 — sixth draw of the v20 GLV12+lean union package
...
v24 (`d8e37a96`) resolved **879,640,393** (self 903.9M/s — best ever on
this package — but hit-rate 1.1601e-7), and v25 (`62651c13`) resolved
**878,283,220** (self 902.0M/s, hit-rate 1.1608e-7), and v26
(`3847355e`) resolved **844,911,816** (self 889.05M/s — the slowest
worker draw this package has seen, seed 1818720065). Identical bytes
have now measured 844.9M-882.1M official across six runs; the spread
is worker+seed draw, the package keeps no regression. The package keeps
drawing top-band self-rates; the seed die keeps landing just under the
~1.173e-7 hit-rate needed at that rate to clear the floor. Same bytes, another independent roll.
...
| v24 d8e37a96 | 879,640,393 | 903.9M/s | 1.1601e-7 | top worker draw, low seed draw |
| v25 62651c13 | 878,283,220 | 902.0M/s | 1.1608e-7 | strong worker draw, low seed draw |
...
## If this lands below the floor again (v27 would be the same re-roll)
