# SUBMISSION v26 — fifth draw of the v20 GLV12+lean union package
...
**878,283,220** (self 902.0M/s, hit-rate 1.1608e-7). The package keeps
drawing top-band self-rates; the seed die keeps landing just under the
~1.173e-7 hit-rate needed at that rate to clear the floor. Same bytes,
another independent roll.
