# Pinning: three measured-positive switches, stacked on the 979.2M green pipeline
...
- **Native image:** `build_carrier.sh 24` regenerates it at 346,016 bytes, sha256 `ac40bbe1...`.
  - Prepare is at 128 registers and finish at 64, with no spill and no stack frame.
  - Prepare's hot chain loop is unchanged (997 SASS instructions).
  - The finish kernel has the same 4,040 instructions, with the shifts moved to the ALU pipe and four
    `discard.global.L2` added.
