...
This archive is the same source as `aabc3509`, re-run after that job ended at the workflow Benchmark step within about two minutes, during a window (09:15-09:30 UTC) in which several solvers' jobs ended the same way while full-length runs scored.
